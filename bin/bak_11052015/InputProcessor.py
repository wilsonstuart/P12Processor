...
# COMPANY: --- 
# VERSION: 1.0 
# CREATED: 15-Feb-2015 11:30:40 CET 
# REVISION: --- 
#=============================================================================== 
...
if parseXMLFile:
    ...
    #iter = tree.iter("dsig:X509SubjectName")
    ...
    for child in subjectCert:
        print child.text
    print "######### subjectName ########"
    subjectNameList = xmldoc.getElementsByTagName('dsig:X509SubjectName') 
    print len(subjectNameList)
    for node in xmldoc.getElementsByTagName('dsig:X509Certificate'):
    ...
    try:
        ...
        for line in REQFILEHANDLE:
            if line.startswith("DN:"):
                ...
                #=============================================================
                pipe = Popen(["openssl", "req", "-new", "-key", key, "-batch","-x509","-subj", subject],stdout=PIPE, stderr=PIPE, universal_newlines=False)
...
def generateCSR(DNString,priKey):
    return True
...
def buildPKCS10XKMSReq(reqFile, xkmsReqOutput):
    ...
    for line in REQFILEHANDLE:
        if line.startswith("DN:"):
            ...
            pipe = Popen(["openssl", "req", "-new", "-key",privateKeyArray[counter], "-batch","-subj", subject],stdout=PIPE, stderr=PIPE, universal_newlines=False)
